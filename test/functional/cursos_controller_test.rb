...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { anio: @curso.anio, division: @curso.division, nombre: @curso.nombre, organizacion_id: @curso.organizacion_id }
    end
  ...
  test "should update curso" do
    put :update, id: @curso, curso: { anio: @curso.anio, division: @curso.division, nombre: @curso.nombre, organizacion_id: @curso.organizacion_id }
    assert_redirected_to curso_path(assigns(:curso))
  end
